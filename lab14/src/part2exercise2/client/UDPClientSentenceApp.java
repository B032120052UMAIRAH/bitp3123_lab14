 ...
 * The task of the client class is to send a request to the server in order to determine the count 
 * of vowels, consonants, and punctuation marks in
 * a sentence provided by the user.
 * 
