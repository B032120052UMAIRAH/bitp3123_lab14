 ...
 * The server class employs UDP Stream to handle and compute the count of vowels, consonants, 
 * and punctuation marks in a sentence received from the client. 
 * Subsequently, it sends the results back to the client.
 * 
	...
	public static void main(String[] args) {
	        ...
	        try {
	        	...
	        	while (true) {
		            ...
		            System.out.println("Message sent for total Vowel : " 
		            		+ totalVowel  + ".\n");
		            
		            datagramSocket.send(outPacket1);
		            System.out.println("Message sent for total Consonant : " 
		            		+ totalConso  + ".\n");
		            
		            datagramSocket.send(outPacket2);
		            System.out.println("Message sent for total Punctuation : " 
		            		+ totalPunct  + ".\n");
