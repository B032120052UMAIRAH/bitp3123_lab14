 ...
 * 
 * The purpose of this class is to transmit three numbers to the server and 
 * obtain two outcomes (the sum and product) from the server.
 * 
...
public class TCPSummationClientApp {
	public static void main(String [] args)
	{
		...
		System.out.println("\n\n\tEnd of execution at TCPSummationClientApp");
